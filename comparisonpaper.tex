...
%---
\begin{stusubfig}{!t}
	\subfigure[Forest X]{\includegraphics[width=.22\linewidth]{convergencemerging-example-a.png}}%
	\hspace{4mm}%
	\subfigure[Forest Y]{\includegraphics[width=.22\linewidth]{convergencemerging-example-b.png}}%
	\hspace{4mm}%
	\subfigure[SlowMerge(X,Y)]{\includegraphics[width=.22\linewidth]{convergencemerging-example-c.png}}%
	\hspace{4mm}%
	\subfigure[FastMerge(X,Y)]{\includegraphics[width=.22\linewidth]{convergencemerging-example-d.png}}%
\caption{TODO}
